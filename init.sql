...
CREATE TABLE person (
    ...
    CONSTRAINT fk_person_house
        ...
        ON DELETE RESTRICT,
    CONSTRAINT fk_person_adoptive_house
        FOREIGN KEY (adoptive_house_id) REFERENCES house(id)
        ON DELETE SET NULL
);
...
CREATE TABLE parent_child (
    ...
    status ENUM('confirmed','rumored') NOT NULL DEFAULT 'confirmed',
...
CREATE TABLE partnership (
    ...
    CONSTRAINT fk_partnership_person1
        FOREIGN KEY (person1_id) REFERENCES person(id)
        ON DELETE CASCADE,
    CONSTRAINT fk_partnership_person2
